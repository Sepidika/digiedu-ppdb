...
@section('seo_title', 'Berita & Pengumuman - ' . $settings['nama_sekolah'])
@section('seo_description', 'Kumpulan berita, pengumuman, dan artikel terbaru dari ' . $settings['nama_sekolah'] . '. Info PPDB, kegiatan sekolah, dan prestasi siswa.')
@section('seo_keywords', 'berita sekolah, pengumuman PPDB, ' . $settings['nama_sekolah'])
